...
const portfolioData = {
    "experience": [
        ...
        {
            "id": 1772046694893,
            "role": "MTO - Business Operations",
            "company": "WeGro Global",
            "duration": "Nov 2024 - Apr 2025",
            "description": "Γû¬ Manage bank portfolio, ensuring financing for 200+ smallholder farmers. \nΓû¬ Liaise with partner banks and optimize processes with digital solutions. \nΓû¬ Identify agri-value chain opportunities and drive growth through strategic partnerships.",
    ...
    "stack": [
        ...
        {
            "name": "Figma",
            "desc": "Design & Wireframing",
            "icon": "M12 2v20M17 5H7v14h10z"
        },
        {
            "name": "Trello",
            "desc": "Task Tracking",
            "icon": "M4 4h16v16H4zM8 8v8M16 8v4"
        },
        {
            "name": "Notion",
            "desc": "Documentation",
        ...
        },
        {
            ...
            "desc": "Data & Metrics",
            "icon": "M2 22h20M6 18v-8M12 18v-12M18 18v-4"
        }
    ],
    "updates": [
        {
    ...
    "credentials": [
        {
            "id": "csca",
            "title": "CSCAΓäó (Certified Supply Chain Analyst)",
            "issuer": "ISCEA",
            "date": "2025",
            "icon": "≡ƒôª"
        },
        {
            "id": "pspo",
            "title": "PSPOΓäó I (Professional Scrum Product Owner)",
            "issuer": "Scrum.org",
    ...
    "linkedinPosts": [
        {
            "title": "≡¥æ╢≡¥Æù≡¥Æå≡¥Æô ≡¥Æò≡¥Æë≡¥Æå ≡¥Æì≡¥Æé≡¥Æö≡¥Æò 8 ≡¥ÆÄ≡¥ÆÉ≡¥ÆÅ≡¥Æò≡¥Æë≡¥Æö, ≡¥Æì≡¥Æå≡¥Æé≡¥Æà≡¥Æè≡¥ÆÅ≡¥Æê ≡¥Æò≡¥Æë≡¥Æå ≡¥Æå≡¥ÆÅ≡¥Æà-≡¥Æò≡¥ÆÉ-≡¥Æå≡¥ÆÅ≡¥Æà ≡¥Æå≡¥ÆÖ≡¥Æå≡¥Æä≡¥Æû≡¥Æò≡¥Æè≡¥ÆÉ≡¥ÆÅ ≡¥ÆÉ≡¥Æç \"≡¥æ╖≡¥ÆÉ≡¥Æÿ≡¥Æå≡¥Æô ≡¥æ«≡¥Æå≡¥ÆÅ≡¥Æè≡¥Æå ≡¥æ╖≡¥Æô≡¥ÆÉ≡¥Æï≡¥Æå≡¥Æä≡¥Æò\" ≡¥Æë≡¥Æé≡¥Æö ≡¥Ææ≡¥Æû≡¥Æö≡¥Æë≡¥Æå≡¥Æà ≡¥ÆÄ≡¥Æå ≡¥Æò≡¥ÆÉ ≡¥Æä≡¥ÆÉ≡¥ÆÅ≡¥Æö≡¥Æò≡¥Æé≡¥ÆÅ≡¥Æò≡¥Æì≡¥ÆÜ ≡¥ÆÄ≡¥ÆÉ≡¥Æù≡¥Æå ≡¥Æâ≡¥Æå≡¥Æò≡¥Æÿ≡¥Æå≡¥Æå≡¥ÆÅ ≡¥Æò≡¥Æë≡¥Æô≡¥Æå≡¥Æå ≡¥Æù≡¥Æå≡¥Æô≡¥ÆÜ ≡¥Æà≡¥Æè≡¥Æç≡¥Æç≡¥Æå≡¥Æô≡¥Æå≡¥ÆÅ≡¥Æò ≡¥ÆÄ≡¥Æè≡¥ÆÅ≡¥Æà≡¥Æö≡¥Æå≡¥Æò≡¥Æö",
